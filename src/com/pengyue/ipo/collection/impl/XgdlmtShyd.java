 ...
 *
 */
public class XgdlmtShyd extends CollectionNews {

	@Override
	public void collection() {
		String url = "http://www.inmediahk.net/taxonomy/term/5034";
		String nextUrl = null;
			...
			do {
				...
				for (Element ele : eles) {
					...
					if (!getNewsService().urlExists(href)) {
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XGDLMT_SHYD, "0", desc, context, href);
						newsList.add(news);
					}
				}
