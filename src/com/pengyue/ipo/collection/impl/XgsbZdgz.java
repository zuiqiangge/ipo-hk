 ...
 *
 */
public class XgsbZdgz extends CollectionNews {
	
	@Override
	public void collection() {
		String url = "http://www.hkcd.com.hk/node_30607.htm";
		String nextUrl = null;
		try {
			...
			do {
				...
				for (Element ele : eles) {
					...
					if (!getNewsService().urlExists(href)) {
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XGSB_ZDGZ, "0", desc, context, href);
						//添加到List
						newsList.add(news);
					}
				}
