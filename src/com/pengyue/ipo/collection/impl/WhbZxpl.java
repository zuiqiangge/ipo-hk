 ...
 *
 */
public class WhbZxpl extends CollectionNews {
	
	@Override
	public void collection() {
		String url = "http://paper.wenweipo.com/catList-s.php?cat=057PL&loc=any";
		String nextUrl = null;
		try {
			...
			do {
				...
				for (Element ele : eles) {
					...
					if (!getNewsService().urlExists(href)) {
						...
						News news = getNewsBean(title, pubDate, SourceInfo.WHB_ZXPL, "0", desc, context, href);
						//添加到List
						newsList.add(news);
					}
				}
