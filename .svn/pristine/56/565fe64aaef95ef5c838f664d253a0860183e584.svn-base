 ...
 *
 */
public class XgdlmtMtwz extends CollectionNews {

	@Override
	public void collection() {
		String url = "http://www.inmediahk.net/taxonomy/term/5018";
		String nextUrl = null;
			...
			do {
				...
				for (Element ele : eles) {
					...
					if (!getNewsService().urlExists(href)) {
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XGDLMT_MTWZ, "0", desc, context, href);
						newsList.add(news);
					}
				}
