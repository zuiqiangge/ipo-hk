 ...
 *
 */
public class XdrbDlxw extends CollectionNews {
	...
	public void collection() {
		...
		try {
			do {
				...
				String url = "http://std.stheadline.com/daily/section-list.php?page="+page+"&cat=16";
				...
				for (Element ele : eles) {
					...
					if(!getNewsService().urlExists(href)){
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XDRB_DLXW, "0", desc, context, href);
						newsList.add(news);
					}
				}
